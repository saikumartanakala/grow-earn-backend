...
public class ViewerProfileController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ViewerProfileController.class);
    ...
    public ViewerProfileController(UserRepository userRepository, UserViolationRepository violationRepository, 
     ...
     * Update current viewer's profile
     */
    @PutMapping
    public ResponseEntity<?> updateProfile(@RequestBody Map<String, Object> body, HttpServletRequest req) {
        ...
        logger.info("Viewer profile updated for user {}", userId);
    ...
    /**
     * PUT /api/viewer/profile/password
     * Update password
     */
    @PutMapping("/password")
    public ResponseEntity<?> updatePassword(@RequestBody Map<String, Object> body, HttpServletRequest req) {
        ...
        userRepository.save(user);
        logger.info("Password updated for viewer {}", userId);
